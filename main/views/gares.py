...
class ContexteGares():
	...
	def fichier_gares(self, fichier):#lis le fichier contenant les gares, retourne toutes les infos liées aux gares
		...
		try:
			with open(fichier, 'r', encoding='utf-8') as json_file:#Vérifie si le fichier existe et s'il n'est pas vide
				infos_gares = json.load(json_file)#Récupère le fichier
